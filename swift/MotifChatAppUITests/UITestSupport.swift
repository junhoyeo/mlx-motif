...
enum A11y {
    static let sidebarChat = "motif.sidebar.chat"
    ...
    static let endpoint = "motif.chat.endpoint"
...
extension XCTestCase {
    ...
    /// Navigate the sidebar to the Chat pane.
    func openChat(_ app: XCUIApplication, file: StaticString = #filePath, line: UInt = #line) {
        let chat = element(app, A11y.sidebarChat)
        requireExists(chat, "sidebar Chat row", file: file, line: line)
        chat.click()
    }
